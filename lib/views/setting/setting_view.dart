...
import 'package:clnapp/views/setting/lnlambda_setting.dart';
import 'package:clnapp/views/setting/unix_setting.dart';
import 'package:flutter/material.dart';
import 'package:file_picker/file_picker.dart';
import 'package:shared_preferences/shared_preferences.dart';

import 'grpc_setting.dart';
  ...
  Widget _buildCorrectSettingView(
    ...
    switch (setting.clientMode!) {
      ...
      case ClientMode.unixSocket:
        return UnixSetting(context: context);
      case ClientMode.lnlambda:
        return LnlambdaSetting(context: context);
    }
  }
